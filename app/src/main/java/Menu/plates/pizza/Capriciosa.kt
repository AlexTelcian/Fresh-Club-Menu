...
class Capriciosa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.platesView.setImageResource(R.drawable.capriciosa)
        binding.namePlatesView.setText("Capriciosa 30 cm")
        binding.ingredientsPlateView.setText("Sos de rosii, oregano, sunca presata, ciuperci, ardei gras, masline, mozzarella")
        ...
        binding.addToOrderButton.setOnClickListener{
            val imageCode = R.drawable.capriciosa
            val order = Order(imageCode, count.toString() + "x Capriciosa 30 cm", binding.personalizationView.text.toString(), price.toString())
            ...
            startActivity(Intent(this@Capriciosa, RestaurantMenu::class.java))
        }
    }
