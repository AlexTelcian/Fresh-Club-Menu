...
class ProsciuttoFunghi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.platesView.setImageResource(R.drawable.proscuittofunghi)
        binding.namePlatesView.setText("Prosciutto e funghi 30 cm")
        binding.ingredientsPlateView.setText("Sos de rosii, sunca, ciuperci, mozzarella")
        ...
        binding.addToOrderButton.setOnClickListener{
            val imageCode = R.drawable.proscuittofunghi
            val order = Order(imageCode, count.toString() + "x Prosciutto e funghi 30 cm", binding.personalizationView.text.toString(), price.toString())
            ...
            startActivity(Intent(this@ProsciuttoFunghi, RestaurantMenu::class.java))
        }
    }
