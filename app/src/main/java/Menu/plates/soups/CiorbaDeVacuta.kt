...
class CiorbaDeVacuta : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.platesView.setImageResource(R.drawable.ciorbavacuta)
        binding.namePlatesView.setText("Ciorba de vacuta")
        binding.ingredientsPlateView.setText("Carne de vita, morcov, patrunjel, pastarnac, telina, ceapa, cartof, mazare, fasole verde, suc de rosii")
        ...
        binding.addToOrderButton.setOnClickListener{
            val imageCode = R.drawable.ciorbavacuta
            val order = Order(imageCode, count.toString() + "x Ciorba de vacuta", binding.personalizationView.text.toString(), price.toString())
            ...
            startActivity(Intent(this@CiorbaDeVacuta, RestaurantMenu::class.java))
        }
    }
