...
class Pepsi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.platesView.setImageResource(R.drawable.pepsi)
        binding.namePlatesView.setText("Pepsi 0.5l")
        ...
        binding.addToOrderButton.setOnClickListener{
            val imageCode = R.drawable.pepsi
            val order = Order(imageCode,  count.toString() + "x Pepsi", binding.personalizationView.text.toString(), price.toString())
            ...
            startActivity(Intent(this@Pepsi, RestaurantMenu::class.java))
        }
    }
